...
class Point(object):
    ...
    def move_to(self, x, y):
        currentpoint = Point(self.x, self.y)
        self.x = x
        self.y = y
        self.moves = self.moves + 1
        self.totaldistance = self.totaldistance + math.sqrt((((self.x - currentpoint.x) ** 2) + (self.y - currentpoint.y) ** 2))

    def move_by(self, dx, dy):
        self.x = self.x + dx
        self.y = self.y + dy
        self.moves = self.moves + 1
        self.totaldistance = self.totaldistance + math.sqrt((((dx) ** 2) + (dy) ** 2))
    ...
    def get_distance_from_start(self):
        distance = math.sqrt((((self.x - self.startpoint.x) ** 2) + (self.y - self.startpoint.y) ** 2))
        return distance
    ...
    def closer_to(self, point1, point2):
        distance1 = math.sqrt((((self.x - point1.x) ** 2) + (self.y - point1.y) ** 2))
        distance2 = math.sqrt((((self.x - point2.x) ** 2) + (self.y - point2.y) ** 2))
